(() => {
  ...
  function App() {
    ...
    const handleReset = async () => {
      ...
      setQuery("");
      try {
        await axios_default.post("https://leadspilotai.onrender.com/api/reset");
      } catch (err) {
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", { className: "chat-container" }, /* @__PURE__ */ import_react.default.createElement("h2", null, " Chat"), /* @__PURE__ */ import_react.default.createElement("div", { className: "chat-box", ref: chatBoxRef }, messages.map((m, i) => /* @__PURE__ */ import_react.default.createElement("div", { key: i, className: "message-pair" }, m.user && /* @__PURE__ */ import_react.default.createElement("div", { className: "user-msg" }, /* @__PURE__ */ import_react.default.createElement("strong", null, "You:"), " ", m.user), m.bot && /* @__PURE__ */ import_react.default.createElement("div", { className: "bot-msg" }, /* @__PURE__ */ import_react.default.createElement("strong", null, "Clyde:"), " ", m.bot), /* @__PURE__ */ import_react.default.createElement("hr", null))), loading && /* @__PURE__ */ import_react.default.createElement("div", { className: "loading" }, "Bot is typing..."), messages.length === 1 && /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("div", { className: "faq-divider" }, "Try a common question:"), /* @__PURE__ */ import_react.default.createElement("div", { className: "faq-buttons" }, faqs.map((q, idx) => /* @__PURE__ */ import_react.default.createElement(
      "button",
      {
        key: idx,
      ...
      q
    ))))), /* @__PURE__ */ import_react.default.createElement("form", { onSubmit: handleSubmit, className: "chat-form" }, /* @__PURE__ */ import_react.default.createElement(
      "input",
      {
    ...
    ), /* @__PURE__ */ import_react.default.createElement("div", { className: "chat-form-buttons" }, /* @__PURE__ */ import_react.default.createElement("button", { type: "submit", disabled: !query.trim() || loading }, "Send"), /* @__PURE__ */ import_react.default.createElement("button", { type: "button", onClick: handleReset }, "Reset Chat")), /* @__PURE__ */ import_react.default.createElement("div", { className: "branding" }, "Powered by LeadsPilotAi")));
  }
  var App_default = App;
  ...
  function ChatWidget() {
    ...
    return /* @__PURE__ */ import_react2.default.createElement("div", { className: "chat-widget-wrapper" }, isOpen && /* @__PURE__ */ import_react2.default.createElement("div", { className: "chat-widget-popup" }, /* @__PURE__ */ import_react2.default.createElement(App_default, null)), /* @__PURE__ */ import_react2.default.createElement("button", { className: "chat-bubble", onClick: toggleWidget }, isOpen ? "\u2715" : "\u{1F4AC}"));
  }
  ...
  function mountWidget() {
    ...
    root.render(/* @__PURE__ */ import_react3.default.createElement(ChatWidget_default, null));
  }
